...
Every prompt uses this base style. Append to all prompts:

> *Dark isometric concept art, near-black background #0A0A0F, cyberpunk-medieval fusion, no warm colors, no gold/amber/parchment, no humans, no faces with visible eyes, square 1:1 framing, creature centered with breathing room, no text or letters in image, ultra-detailed, painterly, Diablo 2 meets Cyberpunk Edgerunners aesthetic.*

---

## ARENA BEASTS (15)

Captured, smuggled, transported to the arena. Visible signs of confinement: chains, shock-collars, cage marks, restraint cuffs, weld-scars. Background suggests arena (dust, distant crowd lights, blood-stained sand) — not the wet streets.

### TIER 1 — Common (small scrap-bots)

**1. Rogue Daemon** *(npc-rogue-daemon.jpg)*
> A small dog-sized service robot with a heavy shock-collar around its neck, dragged into the arena on a frayed chain leash. Cracked plastic shell, exposed servo joints, one cracked optical lens flickering. Its original utility tray jammed with broken weapons. Dented chassis covered in arena tally-marks. Crouched on bloodstained sand under arena spotlights.

**2. Cache Ghoul** *(npc-cache-ghoul.jpg)*
> A hunched humanoid robot, wrists shackled with magnetic restraint cuffs that periodically spark. Exposed memory-module spine. Skin is patched riot-cop armor over rusted endoskeleton. Jaw hangs loose, leaking blue coolant. One eye-cluster missing. Standing in arena dust, distant crowd silhouettes blurred behind it.

**3. Packet Drake** *(npc-packet-drake.jpg)*
> A small reptilian robot the size of a large dog, body of segmented router casings welded into scale-plates. A thick chain runs from a collar on its neck to a bolt in the arena floor. Six wire-tendril whiskers. Claws spark. Cage marks visible on its armor. Crouched mid-snarl on bloodstained sand.

**4. Bitrot Wraith** *(npc-bitrot-wraith.jpg)*
> A tall thin robotic figure draped in a tattered raincloak made of corroded mylar shielding. Iron manacle around one ankle, chain trailing offscreen. Body underneath half-disassembled, missing chest panels. Faint static hisses from a damaged speaker grille for a face. Trails wisps of vapor from leaking thermal fluid. Staggering in arena dust.

**5. Stale Socket** *(npc-stale-socket.jpg)*
> A mechanical crab the size of a microwave, body is a corroded server brick covered in bent ethernet ports. Eight legs made of welded port-pins. Confined inside a circular cage drawn on the arena floor, marked with shock-perimeter sigils. Two glowing port-eyes. Sparks dribble from a cracked power input.

### TIER 2 — Uncommon (mid-size battle-bots)
...
**11. Phantom Root** *(npc-phantom-root.jpg)*
> A skeletal robot king bound to a heavy iron throne fused from server-rack tower segments. Multiple shock-collars at its neck, chest, and wrists — keeping its admin privileges suppressed. Robe is layered torn permission tags. Crown is a circle of soldered key-cards. Skeletal alloy hands hold a master keycard dripping black coolant.

**12. Corrupted Overseer** *(npc-corrupted-overseer.jpg)*
> A floating reconnaissance drone the size of a refrigerator (wings clipped down from full size for transport), eight cracked surveillance lenses around a central armored sphere. Six articulated robotic arms hang below it, restrained by tensioned cables that bolt to the arena ceiling. Slowly rotating, casting cyan and magenta searchlight beams across bloodstained sand below.

**13. Byzantine Shade** *(npc-byzantine-shade.jpg)*
> A massive robotic figure with three torsos fused at the hip, each in different faction armor. Heads are featureless polished consensus-helms. All six arms locked into stasis cuffs that spark and disengage one at a time during fights. Stands at the center of an arena containment circle. Six mismatched weapons holstered on its frame.
